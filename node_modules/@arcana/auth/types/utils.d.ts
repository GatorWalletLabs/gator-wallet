import { AppMode, ConstructorParams, WalletType, WalletPosition, WalletSize, Position, Theme, Network } from './typings';
...
declare const setWalletSize: (element: HTMLElement, sizes: WalletSize, isViewportSmall: boolean) => void;
declare const setWalletPosition: (element: HTMLElement, position: WalletPosition) => void;
declare const getWalletSize: () => WalletSize;
declare const getWalletPosition: (isViewportSmall: boolean, position: Position, isWidgetBubble: boolean) => WalletPosition;
...
export { constructLoginUrl, createDomElement, getWalletType, setWalletSize, getWalletSize, setWalletPosition, getUniqueId, getWalletPosition, verifyMode, preLoadIframe, getErrorReporter, validateAppAddress, addHexPrefix, removeHexPrefix, redirectTo, setFallbackImage, getFallbackImage, getHexFromNumber, getCurrentUrl, getConstructorParams, getParamsFromClientId, isClientId, };
